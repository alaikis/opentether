...
<header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-30">
	...
	<div class="flex items-center gap-4">
		<!-- Notification -->
		<button class="relative p-2 rounded-lg hover:bg-slate-100 transition-colors text-slate-500 hover:text-slate-700">
		...
		<div class="flex items-center gap-3 pl-4 border-l border-slate-200">
			...
			<div class="hidden sm:block text-sm">
				<div class="font-medium text-slate-700">管理员</div>
				<div class="text-xs text-slate-400">admin@opentether</div>
			</div>
		</div>
	</div>
</header>
